...
import threading
from reports_service_helper import *
import boto3
import json
...
region = 'us-east-1'
this_script_server = ['bssrating-bs1.bssva0.dev.vonagenetworks.net:9092','bssrating-bs2.bssva0.dev.vonagenetworks.net:9092']
number = '+18669010242'
consumer = KafkaConsumer(bootstrap_servers=this_script_server,               # straps the host and port together
                         auto_offset_reset='earliest',                       #offset is position within partition, saying send the next message
                         consumer_timeout_ms=1000, api_version=(2, 3, 0))    #how long the consumer will wait
    ...
    for API_KEY in api_key_list:
        for country in country_list:
            for productId in productId_list:
                for action in action_list:
                    try:
                        ...
                        producer.send('event_subscription_subscription_badger', bytes(record, 'utf-8'))
            ...
            try:
                ...
                #print(record)
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_connector_mt_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_hub_core-mt_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                #print(record)
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_hub_all-mo_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_verify_verify_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            for product in product_list:
                ...
                for lookupType in lookupType_list:
                    try:
                        ...
                        msg_id = "NEXMO_" + str(msg_id)
                        producer.send('event_hlr_requests_anonymized_badger', bytes(record, 'utf-8'))
                        cdr_list.append(msg_id)
                        print("Producer record sent")
                    except Exception as e:
                        print(e)
            ...
            try:
                ...
                producer.send('event_chatapp_mo_anonymized_badger' , bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id) + "_delivered"
                producer.send('event_chatapp_dr_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_connector_final-states_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                print(record)
                producer.send('event_sip_inbound_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                print(record)
                producer.send('event_sip_outbound_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_tts_call_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
                print("Producer record sent - TTS record -> TTS record -> event_tts_call_anonymized")
            except Exception as e:
                try:
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_ted_ip-audio-end_anonymized_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
            ...
            try:
                ...
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_ted_ip-messaging-new_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
            ...
            try:
                 ...
                 msg_id = "NEXMO_" + str(msg_id)
                 producer.send('event_ted_cs-custom-event-new_badger', bytes(record, 'utf-8'))
                 cdr_list.append(msg_id)
            ...
            try:
                 ...
                 msg_id = "NEXMO_" + str(msg_id)
                 producer.send('event_ted_websocket-call-done_badger', bytes(record, 'utf-8'))
                 cdr_list.append(msg_id)
            ...
            try:
                 ...
                 msg_id = "NEXMO_" + str(msg_id)
                 producer.send('event_ted_asr-done_anonymized_badger', bytes(record, 'utf-8'))
                 cdr_list.append(msg_id)
            ...
            try:
                ...
                print(record)
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_ted_reports-sync_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
            ...
            try:
                ...
                print(record)
                msg_id = "NEXMO_" + str(msg_id)
                producer.send('event_ted_reports-async_badger', bytes(record, 'utf-8'))
                cdr_list.append(msg_id)
...
def dynamo_verification(cdr_list, region):
    for cid in cdr_list:
        print(cid)
        try:
            items = dynamo_query("vusage-badger-usage-history", "originId", cid, region)
            for v in items:
